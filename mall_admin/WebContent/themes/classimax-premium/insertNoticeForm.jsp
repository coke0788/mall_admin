				...
				<div class="row">
					...
					<div class="widget change-email mb-0">
						...
						<input type="text" name="managerId" value=<%=manager.getManagerId()%> hidden="hidden">
							...
							<!-- Submit Button -->
							<button type="submit" class="btn btn-transparent py-2">POST</button>
							<a href="<%=request.getContextPath()%>/themes/classimax-premium/noticeList.jsp"><button type="button" class="btn btn-outline-secondary py-2">CANCEL</button></a>
						</form>
					</div>
					</div>
				</div>
